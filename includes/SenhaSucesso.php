  ...
  <div class="modal-dialog " role="document" style="width:280px;margin-top:-210px;margin-left:-140px;">
	<div class="modal-content panel panel-success">
	  ...
	  <div class="modal-body panel-body">
		<div align=center><p><strong>Senha atualizada com sucesso!</strong></p>
		</div>
		<div class='form-horizontal' style='text-align:center;'>
			<a class='btn btn-default btn-custom form-group' style='width:150px' data-toggle='modal' data-target='#troca_senha'>OK</a>
		</div>
	  </div>
	</div>
  </div>
