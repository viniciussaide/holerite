<?php
	...
	$query = "
		ALTER TABLE `desconto` DROP FOREIGN KEY `Holerite_matricula_fk`;
		ALTER TABLE `holerite` DROP FOREIGN KEY `matricula_fk`;
		ALTER TABLE `imposto_arquivo` DROP FOREIGN KEY `imposto_arquivo_fk`;
		ALTER TABLE `provento` DROP FOREIGN KEY `provento_ibfk_1`;
