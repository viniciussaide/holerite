...
function randomCode($length = 4) {
	...
	if (isset($pasta_holerite)AND(count($pasta_holerite)>=1)){
		foreach($pasta_holerite as $arquivo_holerite) {
	...
	if (isset($pasta_efetivo)AND(count($pasta_efetivo)>=1)){
		foreach($pasta_efetivo as $arquivo_efetivo) {
			$data = new Reader("../arquivos/efetivo/".$arquivo_efetivo);
