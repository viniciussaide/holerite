		...
		if ($result){
			while($row = mysqli_fetch_array($result, MYSQL_ASSOC)) {
				...
				elseif ($tipo_menu=='Lateral Dropdown'){
					echo "<li class='nav-header'> <a href=".$pagina_php." data-toggle='collapse' data-target='#userMenu' aria-expanded='false' class='collapsed'>".$nome_menu." <span class='glyphicon glyphicon-chevron-right'></span></a><ul class='nav nav-stacked collapse' id='userMenu' aria-expanded='false' style='height: 0px;'>";
